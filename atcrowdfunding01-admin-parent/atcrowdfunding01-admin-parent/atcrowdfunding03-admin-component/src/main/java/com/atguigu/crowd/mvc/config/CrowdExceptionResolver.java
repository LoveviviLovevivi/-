...
public class CrowdExceptionResolver {
    ...
    public ModelAndView resolveNullPointerException(LoginFailedException exception,
    ...
    public ModelAndView resolveNullPointerException(LoginAcctAlreadyInuserException exception,
                                                    HttpServletRequest request,
                                                    HttpServletResponse response) throws IOException {
